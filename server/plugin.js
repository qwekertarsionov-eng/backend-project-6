...
export default async (app, _options) => {
  ...
  app.patch("/users/:id", async (request, reply) => {
    ...
    if (password) {
      patchData.passwordDigest = crypto.createHash("sha256").update(password).digest("hex");
    }
    try {
  ...
  app.post("/tasks", async (request, reply) => {
    ...
    try {
      ...
      return flashView(reply, "tasks/new", {
        task: taskData,
        statuses,
        users,
        labels: allLabels,
  ...
  app.get("/tasks/:id/edit", async (request, reply) => {
    ...
    const task = await app.models.Task.query()
  ...
  app.patch("/tasks/:id", async (request, reply) => {
    ...
    try {
      ...
      return flashView(reply, "tasks/edit", {
        task: updateData,
        statuses,
        users,
        labels: allLabels,
  ...
  app.patch("/labels/:id", async (request, reply) => {
    ...
    try {
      ...
      return flashView(reply, "labels/edit", {
